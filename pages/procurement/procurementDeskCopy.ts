...
export const getProcurementDeskCopy = (language: Language): ProcurementDeskCopy => {
  if (language === 'en') return enCopy;
  if (language === 'vi') return viCopy;
  return zhCopy;
};

const enCopy: ProcurementDeskCopy = {
...
const viCopy: ProcurementDeskCopy = {
  eyebrow: 'Luồng mua hàng',
  title: 'Điều hướng trách nhiệm mua hàng',
  description: 'Tách hồ sơ nhà cung cấp, đơn mua và lô nhận hàng để người dùng biết chính xác nơi nhập từng nghiệp vụ.',
  suppliers: {
    title: 'Hồ sơ nhà cung cấp',
    subtitle: 'Tên, địa chỉ, liên hệ',
    purpose: 'Chỉ quản lý danh tính nhà cung cấp, không nhận hàng hoặc ghi tồn kho tại đây.',
  },
  orders: {
    title: 'Đơn mua hàng',
  ...
  receipts: {
    ...
    purpose: 'Ghi nhận từng đợt nhận hàng, số đạt, số lệch, số lô và ghi chú.',
  },
  principle: {
    title: 'Quy tắc ranh giới',
    subtitle: 'Không trộn vùng nhập liệu',
    purpose: 'Phân biệt phần thuộc mua hàng, kho, tài chính và xử lý sai lệch.',
  },
  receiptGuideTitle: 'Nhận hàng là thao tác trên đơn mua',
  receiptGuideBody: 'Chọn một đơn mua, sau đó bấm nút lô nhận hàng trong dòng thao tác. Cách này giữ từng lần nhận hàng gắn với đúng đơn và tránh ghi dữ liệu kho vào hồ sơ nhà cung cấp.',
  ...
  principleCards: [
    ...
    ['Sai lệch và công nợ có sổ riêng', 'Thiếu hàng, từ chối hàng và thanh toán phải được đối soát ở bước sau.'],
  ],
};

const zhCopy: ProcurementDeskCopy = {
  eyebrow: '采购职责分流',
  title: '采购不是一个输入框',
