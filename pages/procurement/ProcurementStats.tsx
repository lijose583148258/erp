...
export const ProcurementStats = ({ t, supplierCount, stats }: ProcurementStatsProps) => (
  <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm dark:bg-slate-900 dark:border-slate-800">
      <p className="text-xs text-slate-400 font-black uppercase tracking-widest mb-4">{t.supplierTotal}</p>
    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm dark:bg-slate-900 dark:border-slate-800">
      <p className="text-xs text-slate-400 font-black uppercase tracking-widest mb-4">{t.activePurchase}</p>
      <div className="flex items-center justify-between">
    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm dark:bg-slate-900 dark:border-slate-800">
      <p className="text-xs text-slate-400 font-black uppercase tracking-widest mb-4">{t.avgLead}</p>
      <div className="flex items-center justify-between">
    ...
    <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm dark:bg-slate-900 dark:border-slate-800">
      <p className="text-xs text-slate-400 font-black uppercase tracking-widest mb-4">{t.riskSuppliers}</p>
      <div className="flex items-center justify-between">
