...
import { EnterpriseDataGrid, type EnterpriseColumn } from '../components/ui/EnterpriseDataGrid';
...
const ReceiptDiscrepancyWorkbench: React.FC = () => {
  ...
  const caseColumns: EnterpriseColumn<ReceiptDiscrepancyCase>[] = [
    {
      key: 'caseNo',
      header: '差异单',
      width: '150px',
  ...
  const ruleColumns: EnterpriseColumn<ReceiptToleranceRule>[] = [
    {
      key: 'ruleNo',
      header: '规则号',
      width: '170px',
