  ...
  return (
    <section className="relative overflow-hidden rounded-[42px] bg-gradient-to-br from-slate-950 via-slate-900 to-blue-950 text-white">
      ...
      <div className="relative p-8 lg:p-10">
        <div className="inline-flex items-center gap-2 rounded-full border border-white/10 bg-white/10 px-4 py-2 text-xs font-black uppercase tracking-[0.3em] text-blue-200">
          <ShieldCheck size={12} />
          异常调账治理台账
        </div>
