...
const run = (adapter, operation, env) => {
  const output = execFileSync(process.execPath, [adapter, operation], {
...
try {
  ...
  console.log('HA adapter contract tests: PASSED');
} finally {
