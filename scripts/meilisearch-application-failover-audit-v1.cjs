...
const reportPath = path.join(root, 'output/audit/meilisearch-failover-audit-v1.json');
...
const account = { username: 'meili_failover_audit', password: 'MeiliFailoverAudit12345!', role: 'admin' };
const report = { name: 'Meilisearch Application Failover Audit', version: '1.2', status: 'failed', startedAt: new Date().toISOString(), checks: [] };
