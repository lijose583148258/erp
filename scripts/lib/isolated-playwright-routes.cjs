...
const defaultRoutes = [
  {
    ...
    hash: '#dashboard',
    title: 'Dashboard',
    expected: ['AilaoDa Business Cockpit', 'Overview', '仪表盘'],
    category: 'smoke',
    severity: 'error',
  ...
  },
  {
    ...
    hash: '#crm',
    title: 'CRM',
    expected: ['Customer Relationship and Credit Files', 'Customers', '客户'],
    category: 'smoke',
    severity: 'error',
    tags: ['crm', 'table'],
    viewport: null,
  },
  {
    ...
    hash: '#orders',
    title: 'Sales Orders',
    expected: ['Sales Order Center', 'Sales Orders', '订单'],
    category: 'smoke',
    severity: 'error',
    tags: ['orders', 'table'],
    viewport: null,
  },
  {
    ...
    hash: '#warehouse',
    title: 'Warehouse',
    expected: ['Warehouse, Locations, and Inventory', 'Warehouse', '库存'],
    category: 'smoke',
    severity: 'error',
  ...
  },
  {
    ...
    hash: '#procurement',
    title: 'Procurement',
    expected: ['Procurement, Suppliers, and Receiving', 'Procurement', '采购'],
    category: 'smoke',
    severity: 'error',
  ...
  },
  {
    ...
    expected: ['Finance Operations Analytics', 'Finance', '财务'],
    category: 'smoke',
    severity: 'error',
  ...
  },
  {
    ...
    expected: ['Users, Roles, and Permissions', 'Org & Roles', '权限'],
    category: 'smoke',
    severity: 'error',
  ...
  },
  {
    ...
    hash: '#audit',
    title: 'Audit Logs',
    expected: ['System Audit and Operation Logs', 'Audit Logs', '审计'],
    category: 'smoke',
    severity: 'error',
    tags: ['audit', 'logs'],
    viewport: null,
...
function normalizeRoute(route, index) {
  ...
  return {
    route: {
      ...
      title: typeof route.title === 'string' && route.title.trim() ? route.title.trim() : String(route.id || '').trim(),
      expected,
