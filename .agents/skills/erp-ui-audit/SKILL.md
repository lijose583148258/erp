---
name: erp-ui-audit
description: UI audit for shell consistency, language switching, layout drift, state rendering, offline asset integrity, and role-driven visibility in the ERP/CRM.
---
...
UI shell, language, states, consistency.
