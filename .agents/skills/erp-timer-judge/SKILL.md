---
name: erp-timer-judge
description: Timebox every action, detect stalls, decide retry vs stuck, and produce a clear verdict and next-step for ERP/CRM runs.
---
