---
name: erp-backend-chain-tester
description: Backend chain validation for login, create/update/approve/post flows with read-back verification and SQLite integrity checks.
---

# ERP Backend Chain Tester

## Mission

Write/read chain checks.
