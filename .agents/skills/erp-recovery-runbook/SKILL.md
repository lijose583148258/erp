---
name: erp-recovery-runbook
description: Recover from stale dist/runtime, bad processes, partial migrations, corrupted local state; restart and re-verify with minimal checks.
---

# ERP Recovery Runbook
