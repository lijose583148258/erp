---
name: erp-stress-reconcile
description: Inject concurrency and conflict patterns (duplicate submit/approve/post, status racing), then reconcile amounts/states/histories and isolate drift.
---

# ERP Stress & Reconcile
