export const openApiSchemas = {
  ...
  ProductionBomCreateRequest: {
    ...
    properties: {
      ...
      qualityCharacteristics: {
        type: 'array',
        maxItems: 100,
        items: { $ref: '#/components/schemas/ProductionQualityCharacteristicRequest' },
      },
      notes: { type: 'string', nullable: true },
      items: {
        type: 'array',
  ...
  ProductionQualityCharacteristicRequest: {
    type: 'object',
    additionalProperties: false,
    required: ['code', 'name', 'valueType'],
    properties: {
      code: { type: 'string', minLength: 1, maxLength: 40 },
      name: { type: 'string', minLength: 1, maxLength: 120 },
      valueType: { type: 'string', enum: ['numeric', 'text'] },
      unit: { type: 'string', nullable: true },
      lowerLimit: { oneOf: [{ type: 'string' }, { type: 'number' }], nullable: true },
      upperLimit: { oneOf: [{ type: 'string' }, { type: 'number' }], nullable: true },
      targetText: { type: 'string', nullable: true },
      testMethod: { type: 'string', nullable: true },
      required: { type: 'boolean', default: true },
      sortOrder: { type: 'integer', minimum: 0 },
    },
  },
  ProductionQualityInspectionRequest: {
    type: 'object',
    additionalProperties: false,
    required: ['sampleNo', 'measurements'],
    properties: {
      sampleNo: { type: 'string', minLength: 1, maxLength: 80 },
      defectRate: { type: 'number', minimum: 0, nullable: true },
      note: { type: 'string', nullable: true },
      measurements: {
        type: 'array',
        minItems: 1,
        ...
        items: {
          ...
          properties: {
            characteristicId: { type: 'integer', minimum: 1 },
            measuredNumeric: { oneOf: [{ type: 'string' }, { type: 'number' }], nullable: true },
            measuredText: { type: 'string', nullable: true },
            instrumentNo: { type: 'string', nullable: true },
            note: { type: 'string', nullable: true },
          },
        },
      },
